...
enum parameters {THERMAL_CONDUCTIVITY,HEAT_X, HEAT_Y, HEAT_Z};
...
class mesh{
    ...
    public:
        void setParameters(float k,float Q_x, float Q_y, float Q_z){
            parameters[THERMAL_CONDUCTIVITY]=k;
            parameters[HEAT_X]=Q_x;
            parameters[HEAT_X]=Q_y;
            parameters[HEAT_X]=Q_z;
        }
